...
void MainWindow::setupUi()
{
    ...
    m_openButton = new QPushButton(QIcon(":/resources/icons/folder_open.svg"), "", this);
    m_openButton->setFixedSize(24, 24);
    m_openButton->setFlat(true);
    controlsLayout->addWidget(m_openButton);
    
    m_playPauseButton = new QPushButton(QIcon(":/resources/icons/play.svg"), "", this);
    ...
    m_timeLabel->setStyleSheet("color: #666; font-family: monospace; font-weight: bold;");
    controlsLayout->addWidget(m_timeLabel);
    
    controlsLayout->addStretch();
    
    // Volume controls
    m_volumeButton = new QPushButton(QIcon(":/resources/icons/arrow_up.svg"), "", this);
    ...
    m_recordButton = new QPushButton(QIcon(":/resources/icons/record.svg"), "REC", this);
    ...
    m_track2Panel = new TrackPanel("Piste 2", m_audioRecorder2, m_track2Container);
    ...
    m_rythmoManager->setText(1, "TRACK 2: Ready for dubbing...");  // Initialize track 2
}
...
void MainWindow::setupConnections()
{
    ...
    connect(m_playbackEngine, &PlaybackEngine::durationChanged,
    ...
    connect(m_playbackEngine, &PlaybackEngine::positionChanged,
            m_rythmoManager, &RythmoManager::sync);
    connect(m_playbackEngine, &PlaybackEngine::positionChanged,
            m_rythmoOverlay, &RythmoOverlay::sync);
    connect(m_playbackEngine, &PlaybackEngine::playbackStateChanged,
    ...
    connect(m_volumeSpinBox, QOverload<int>::of(&QSpinBox::valueChanged),
            this, [this](int value) {
                m_playbackEngine->setVolume(static_cast<float>(value) / 100.0f);
    ...
    connect(m_playbackEngine, &PlaybackEngine::volumeChanged, this, [this](float volume) {
    ...
    connect(m_recordButton, &QPushButton::clicked,
            this, &MainWindow::toggleRecording);
    connect(m_audioRecorder1, &AudioRecorder::errorOccurred,
            this, &MainWindow::onError);
    connect(m_audioRecorder2, &AudioRecorder::errorOccurred,
            this, &MainWindow::onError);
    ...
    connect(m_exportService, &ExportService::progressChanged,
            this, &MainWindow::onExportProgress);
    connect(m_exportService, &ExportService::exportFinished,
...
void MainWindow::onOpenFile()
{
    QString fileName = QFileDialog::getOpenFileName(
        this, tr("Ouvrir"), "", tr("Vidéos MP4 (*.mp4)"));
